...
public class UserMatchApp
{
    ...
    /**
     * Sorts and cuts a list down to the given size. Returns empty list
     * if called with empty list or 0. Returns entire list if num is greater
     * than size of list. Returns the given list if some other error occurs.
     * @param list
     * @param num
     * @return
     */
